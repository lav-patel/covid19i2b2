--##############################################################################
-- just for comparison, original code is from https://github.com/covidclinical/Phase2.1AKIRPackage/tree/master/FourCePhase2.1AKI/inst/extdata/phaseX.1_modified_sql
--### 4CE Phase 1.1
--### Date: May 6, 2020
--### Database: Oracle
--### Data Model: i2b2
